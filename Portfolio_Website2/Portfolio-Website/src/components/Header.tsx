...
function Header() {
  ...
  return (
    <div className="flex items-center w-screen justify-between border-b-[2px] bg-white">
      ...
      <div className="w-[100px] h-[100px] bg-red-500 flex justify-center items-center">
        <svg
